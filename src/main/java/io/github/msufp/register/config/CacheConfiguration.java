package io.github.msufp.register.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(io.github.msufp.register.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(io.github.msufp.register.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
